...
import { parseDetailsJsonFromForm, sanitizeColumnPayload } from "@/lib/listing-detail-config";
import { listingFormSchema, parseListingImageUrlsStrict, rawFromFormData } from "@/lib/listing-form-schema";
import { prisma } from "@/lib/prisma";

export type CreateListingState =
  | { ok: true }
  | { ok: false; error: "unauthorized" | "validation" | "category" | "session" };
