...
const sectionClass = "space-y-4 text-[15px] leading-relaxed text-zinc-700 dark:text-zinc-300";
...
export async function LegalDocumentShell({ slug, children }: Props) {
  ...
  return (
    <div className="min-h-[60vh] bg-[#f9fafb] dark:bg-zinc-950">
      <div className="mx-auto max-w-3xl px-4 py-14 sm:px-6 lg:max-w-[48rem] lg:py-16">
        <Link
          href="/"
        ...
        <article className="mt-10 rounded-2xl border border-zinc-200/90 bg-white px-6 py-10 shadow-[0_8px_30px_-12px_rgba(15,23,42,0.12)] dark:border-zinc-800 dark:bg-zinc-900/90 dark:shadow-black/20 sm:px-10">
          {children}
        </article>
